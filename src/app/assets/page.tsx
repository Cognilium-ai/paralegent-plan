...
const salesAssets: SalesAssetItem[] = [
  ...
  // P0 — Need within Week 2
  {
    ...
    whatToCollect: [
      "Mudassir records authentic 2-min video: why this problem matters, 50+ GenAI systems, 11 specialized agents",
  ...
  },
  {
    ...
    whatToCollect: [
      ...
      "Key numbers: 11 agents, 2-8 min, 40-50 redlines, 80-150 terms",
      "Differentiators: customer-cloud, LLM-agnostic, GREEN/ORANGE/RED, one-time",
      "CTA: Request a Demo",
    ],
  ...
  },
  {
    ...
    whatToCollect: [
      ...
      "3. AI Architecture (11 agents vs single LLM)",
  ...
  },
  {
    ...
    whatToCollect: [
      ...
      "Slide 2: Solution (11 agents, rulebook-driven, Word-native)",
      "Slide 3: How it works (3-step visual)",
      "Slide 4: Differentiators (customer-cloud, LLM-agnostic, one-time)",
  ...
  },
  {
    ...
    whatToCollect: [
      ...
      "5. Architecture diagram: 11 agents → orchestrator → Word",
